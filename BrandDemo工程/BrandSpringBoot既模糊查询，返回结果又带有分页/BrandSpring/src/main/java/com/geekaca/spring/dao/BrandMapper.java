...
//    List<Brand> selectPage(@Param("description") String description);
    ...
    @Select("select * from tb_brand where description like CONCAT('%', #{description}, '%') limit #{pageNum},#{pageSize}")
    public List<Brand> selectPage(Integer pageNum, Integer pageSize,@Param("description") String description);
}