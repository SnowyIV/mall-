...
public class BrandService {
    ...
    public int deleteBatchIds(List<Integer> idList) {
        SqlSession sqlSession = SqlUtil.openSession();
        BrandMapper brandMapper = sqlSession.getMapper(BrandMapper.class);
        return brandMapper.deleteByIds(idList);
    ...
    public List<Brand> selectPage(Integer pageNo, Integer pageSize){
        SqlSession sqlSession = SqlUtil.openSession();
        BrandMapper brandMapper = sqlSession.getMapper(BrandMapper.class);
        return brandMapper.selectFirstPage((pageNo - 1) * pageSize, pageSize);
    }
}
